  ...
  if (typeof define === 'function' && define.amd) {
    ...
    Listloading.prototype = {
        ...
        init: function (options) {
            ...
            // 下拉刷新文字
            this.options.pullDrefreshtxt   = '<i class="icon-down"></i>下拉刷新数据';
            // 正在加载中文字
            this.options.loadertxt         = '<i class="icon-loading"></i>正在加载数据';
            // 松开刷新文字
            this.options.Realtimetxt       = '松开开始加载';
            // 已经全部加载完毕文字
        ...
        createPullUpEle: function (refresh) {
            ...
            // modify by huhy 修复页面变化时候高度的计算
            var viewHeight     = this.ele.height();
